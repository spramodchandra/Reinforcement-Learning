...
def updateStateActionMatrix(stateActionMatrix,currentState,nextState,action,nextaction,reward,alpha,gamma):
    q=stateActionMatrix[action,currentState[0],currentState[1]]
    q1=stateActionMatrix[nextaction,nextState[0],nextState[1]]
    stateActionMatrix[action,currentState[0],currentState[1]]= q + alpha*(reward+gamma*q1-q)
...
def main():
    ...
    for j in range(4000):
        ...
        while pos!=dest:
            ...
            stateActionMatrix = updateStateActionMatrix(stateActionMatrix,pos,newpos,action,nextaction,rewardMatrix[pos],alpha,gamma)
